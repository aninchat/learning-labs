This lab deploys an EVPN VXLAN fabric with the symmetric IRB routing model for inter-VLAN routing using Cisco N9Kv as leafs and spines of a 3-stage Clos architecture. You can deploy the fabric using `sudo containerlab deploy -t nxos-symmetric-routing.clab.yaml -c`.
...
![symmetric-routing-topology](/static/images/nxos-symmetric-routing.png)
